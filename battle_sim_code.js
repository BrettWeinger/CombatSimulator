/* TABLE OF CONTENTS
   Line 7 - UI FUNCTIONS
  Line 431 - INITIALIZE UNIT NAME, CLASS, & LEVEL
  Line 449 - DEFAULT STAT CALCULATIONS (BEST FIT TRENDS)
  Line 819 - REPLACE APPLICABLE STATS WITH USER INPUTS
  Line 897 - INITIALIZE ENEMY NAME, CLASS, & LEVEL
  Line 916 - ENEMY DEFAULT STAT CALCULATIONS (SAME TRENDS AS LINES 449-818)
 Line 1282 - REPLACE APPLICABLE ENEMY STATS WITH USER INPUTS
 Line 1361 - CONFIRMATION MESSAGES
 Line 1373 - EPIC ABILITY RANKS
 Line 1449 - ENEMY EPIC ABILITY RANKS
 Line 1524 - OTHER VARIABLES
 Line 1544 - WEAPON TYPE
 Line 1559 - ENEMY WEAPON TYPE
 Line 1576 - POWER FUNCTIONS
 Line 1854 - UNITS WITH AVAILABLE POWERS
 Line 1902 - COMBAT SIMULATOR
 Line 4336 - OPTION ANALYSIS
 Line 4398 - CALCULATE RESPONSE
 Line 4541 - NOTES
*/
...
var displayMeleeEpics = function() {
    if(document.getElementById('buccaneer_checkbox').checked || document.getElementById('swashbuckler_checkbox').checked || document.getElementById('melee_privateer').checked) {
        document.getElementById('blade_storm_text').innerHTML = "Blade Storm:";
        document.getElementById('cheap_shot_text').innerHTML = "Cheap Shot:";
        document.getElementById('first_strike_text').innerHTML = "First Strike:";
        document.getElementById('flanking_text').innerHTML = "Flanking:";
        document.getElementById('relentless_text').innerHTML = "Relentless:";
        document.getElementById('repel_boarders_text').innerHTML = "Repel Boarders:";
        document.getElementById('riposte_text').innerHTML = "Riposte:";
        document.getElementById('second_chance_text').innerHTML = "Second Chance:";
        document.getElementById('vengeance_strike_text').innerHTML = "Vengeance Strike:";
    }
}
...
var displayRangedEpics = function() {
    if(document.getElementById('musketeer_checkbox').checked || document.getElementById('ranged_privateer').checked) {
        document.getElementById('blade_storm_text').innerHTML = "Double Tap:";
        document.getElementById('cheap_shot_text').innerHTML = "Parting Shot:";
        document.getElementById('first_strike_text').innerHTML = "Quick Draw:";
        document.getElementById('flanking_text').innerHTML = "Crossfire:";
        document.getElementById('relentless_text').innerHTML = "Burst Fire:";
        document.getElementById('repel_boarders_text').innerHTML = "Overwatch:";
        document.getElementById('riposte_text').innerHTML = "Return Fire:";
        document.getElementById('second_chance_text').innerHTML = "Quick Adjust:";
        document.getElementById('vengeance_strike_text').innerHTML = "True Grit:";
    }
}

var displayMagicalEpics = function() {
    if(document.getElementById('witchdoctor_checkbox').checked) {
        document.getElementById('blade_storm_text').innerHTML = "Mojo Rising:";
        document.getElementById('cheap_shot_text').innerHTML = "Coward's Bane:";
        document.getElementById('first_strike_text').innerHTML = "Intuition:";
        document.getElementById('flanking_text').innerHTML = "Doomspell:";
        document.getElementById('relentless_text').innerHTML = "Mojo Echo:";
        document.getElementById('repel_boarders_text').innerHTML = "Readied Spell:";
        document.getElementById('riposte_text').innerHTML = "Counterspell:";
        document.getElementById('second_chance_text').innerHTML = "Jobu's Ruse:";
        document.getElementById('vengeance_strike_text').innerHTML = "Retribution:";
    }
}
...
var lockTextFields = function() {
    if(document.getElementById('buccaneer_checkbox').checked) {
        document.getElementById('elusive').disabled = false;
        document.getElementById('turnthetide').disabled = false;
        document.getElementById('improvedmojoblast').disabled = true;
        document.getElementById('improvedmojoblast').value = "";
        document.getElementById('enemywitchhunter').disabled = true;
        document.getElementById('enemywitchhunter').value = "";
    } else if(document.getElementById('musketeer_checkbox').checked) {
        document.getElementById('elusive').disabled = false;
        document.getElementById('turnthetide').disabled = true;
        document.getElementById('turnthetide').value = "";
        document.getElementById('improvedmojoblast').disabled = true;
        document.getElementById('improvedmojoblast').value = "";
        document.getElementById('enemywitchhunter').disabled = true;
        document.getElementById('enemywitchhunter').value = "";
        ...
        document.getElementById('elusive').disabled = true;
        document.getElementById('elusive').value = "";
        document.getElementById('turnthetide').disabled = true;
        document.getElementById('turnthetide').value = "";
        document.getElementById('improvedmojoblast').disabled = false;
        document.getElementById('enemywitchhunter').disabled = false;
    } else {
        document.getElementById('elusive').disabled = true;
        document.getElementById('elusive').value = "";
        document.getElementById('turnthetide').disabled = true;
...
var displayEnemyMeleeEpics = function() {
    if(document.getElementById('enemy_buccaneer_checkbox').checked || document.getElementById('enemy_swashbuckler_checkbox').checked || document.getElementById('enemy_melee_privateer').checked) {
        document.getElementById('enemy_blade_storm_text').innerHTML = "Blade Storm:";
        document.getElementById('enemy_cheap_shot_text').innerHTML = "Cheap Shot:";
        document.getElementById('enemy_first_strike_text').innerHTML = "First Strike:";
        document.getElementById('enemy_flanking_text').innerHTML = "Flanking:";
        document.getElementById('enemy_relentless_text').innerHTML = "Relentless:";
        document.getElementById('enemy_repel_boarders_text').innerHTML = "Repel Boarders:";
        document.getElementById('enemy_riposte_text').innerHTML = "Riposte:";
        document.getElementById('enemy_second_chance_text').innerHTML = "Second Chance:";
        document.getElementById('enemy_vengeance_strike_text').innerHTML = "Vengeance Strike:";
    }
}
...
var displayEnemyRangedEpics = function() {
    if(document.getElementById('enemy_musketeer_checkbox').checked || document.getElementById('enemy_ranged_privateer').checked) {
        document.getElementById('enemy_blade_storm_text').innerHTML = "Double Tap:";
        document.getElementById('enemy_cheap_shot_text').innerHTML = "Parting Shot:";
        document.getElementById('enemy_first_strike_text').innerHTML = "Quick Draw:";
        document.getElementById('enemy_flanking_text').innerHTML = "Crossfire:";
        document.getElementById('enemy_relentless_text').innerHTML = "Burst Fire:";
        document.getElementById('enemy_repel_boarders_text').innerHTML = "Overwatch:";
        document.getElementById('enemy_riposte_text').innerHTML = "Return Fire:";
        document.getElementById('enemy_second_chance_text').innerHTML = "Quick Adjust:";
        document.getElementById('enemy_vengeance_strike_text').innerHTML = "True Grit:";
    }
}

var displayEnemyMagicalEpics = function() {
    if(document.getElementById('enemy_witchdoctor_checkbox').checked) {
        document.getElementById('enemy_blade_storm_text').innerHTML = "Mojo Rising:";
        document.getElementById('enemy_cheap_shot_text').innerHTML = "Coward's Bane:";
        document.getElementById('enemy_first_strike_text').innerHTML = "Intuition:";
        document.getElementById('enemy_flanking_text').innerHTML = "Doomspell:";
        document.getElementById('enemy_relentless_text').innerHTML = "Mojo Echo:";
        document.getElementById('enemy_repel_boarders_text').innerHTML = "Readied Spell:";
        document.getElementById('enemy_riposte_text').innerHTML = "Counterspell:";
        document.getElementById('enemy_second_chance_text').innerHTML = "Jobu's Ruse:";
        document.getElementById('enemy_vengeance_strike_text').innerHTML = "Retribution:";
    }
}
...
var lockEnemyTextFields = function() {
    if(document.getElementById('enemy_buccaneer_checkbox').checked) {
        document.getElementById('enemyelusive').disabled = false;
        document.getElementById('enemyturnthetide').disabled = false;
        document.getElementById('enemyimprovedmojoblast').disabled = true;
        document.getElementById('enemyimprovedmojoblast').value = "";
        document.getElementById('witchhunter').disabled = true;
        document.getElementById('witchhunter').value = "";
    } else if(document.getElementById('enemy_musketeer_checkbox').checked) {
        document.getElementById('enemyelusive').disabled = false;
        document.getElementById('enemyturnthetide').disabled = true;
        document.getElementById('enemyturnthetide').value = "";
        document.getElementById('enemyimprovedmojoblast').disabled = true;
        document.getElementById('enemyimprovedmojoblast').value = "";
        document.getElementById('witchhunter').disabled = true;
        document.getElementById('witchhunter').value = "";
        ...
        document.getElementById('enemyelusive').disabled = true;
        document.getElementById('enemyelusive').value = "";
        document.getElementById('enemyturnthetide').disabled = true;
        document.getElementById('enemyturnthetide').value = "";
        document.getElementById('enemyimprovedmojoblast').disabled = false;
        document.getElementById('witchhunter').disabled = false;
    } else {
        document.getElementById('enemyelusive').disabled = true;
        document.getElementById('enemyelusive').value = "";
        document.getElementById('enemyturnthetide').disabled = true;
...
var firstStrikeRank = parseInt(document.getElementById("first_strike").value);
if(isNaN(firstStrikeRank)) {
    firstStrikeRank = 0;
} else if(firstStrikeRank > 3) {
    firstStrikeRank = 3;
}
var riposteRank = parseInt(document.getElementById("riposte").value);
if(isNaN(riposteRank)) {
    riposteRank = 0;
} else if(riposteRank > 3) {
    riposteRank = 3;
}
var relentlessRank = parseInt(document.getElementById("relentless").value);
if(isNaN(relentlessRank)) {
    relentlessRank = 0;
} else if(relentlessRank > 3) {
    relentlessRank = 3;
}
var bladeStormRank = parseInt(document.getElementById("blade_storm").value);
if(isNaN(bladeStormRank)) {
    bladeStormRank = 0;
} else if(bladeStormRank > 3) {
    bladeStormRank = 3;
}
var secondChanceRank = parseInt(document.getElementById("second_chance").value);
if(isNaN(secondChanceRank)) {
    secondChanceRank = 0;
} else if(secondChanceRank > 3) {
    secondChanceRank = 3;
}
var vengeanceStrikeRank = parseInt(document.getElementById("vengeance_strike").value);
if(isNaN(vengeanceStrikeRank)) {
    vengeanceStrikeRank = 0;
} else if(vengeanceStrikeRank > 3) {
    vengeanceStrikeRank = 3;
}
var repelBoardersRank = parseInt(document.getElementById("repel_boarders").value);
if(isNaN(repelBoardersRank)) {
    repelBoardersRank = 0;
} else if(repelBoardersRank > 3) {
    repelBoardersRank = 3;
}
var cheapShotRank = parseInt(document.getElementById("cheap_shot").value);
if(isNaN(cheapShotRank)) {
    cheapShotRank = 0;
} else if(cheapShotRank > 3) {
    cheapShotRank = 3;
}
var flankingRank = parseInt(document.getElementById("flanking").value);
if(isNaN(flankingRank)) {
    flankingRank = 0;
} else if(flankingRank > 3) {
    flankingRank = 3;
}
var holdTheLineRank = parseInt(document.getElementById("hold_the_line").value);
if(isNaN(holdTheLineRank)) {
    holdTheLineRank = 0;
} else if(holdTheLineRank > 3) {
    holdTheLineRank = 3;
}
var elusiveRank = parseInt(document.getElementById("elusive").value);
if(isNaN(elusiveRank)) {
    elusiveRank = 0;
} else if(elusiveRank > 3) {
    elusiveRank = 3;
}
var turnTheTideRank = parseInt(document.getElementById("turnthetide").value);
if(isNaN(turnTheTideRank)) {
    turnTheTideRank = 0;
} else if(turnTheTideRank > 3) {
    turnTheTideRank = 3;
}
var improvedMojoBlastRank = parseInt(document.getElementById("improvedmojoblast").value);
if(isNaN(improvedMojoBlastRank)) {
    improvedMojoBlastRank = 0;
} else if(improvedMojoBlastRank > 3) {
    improvedMojoBlastRank = 3;
}
var witchHunterRank = parseInt(document.getElementById("witchhunter").value);
if(isNaN(witchHunterRank)) {
    witchHunterRank = 0;
} else if(witchHunterRank > 3) {
    witchHunterRank = 3;
}
    
// SET ENEMY EPIC ABILITY RANKS
var enemyFirstStrikeRank = parseInt(document.getElementById("enemy_first_strike").value);
if(isNaN(enemyFirstStrikeRank)) {
    enemyFirstStrikeRank = 0;
} else if(enemyFirstStrikeRank > 3) {
    enemyFirstStrikeRank = 3;
}
var enemyRiposteRank = parseInt(document.getElementById("enemy_first_strike").value);
if(isNaN(enemyRiposteRank)) {
    enemyRiposteRank = 0;
} else if(enemyRiposteRank > 3) {
    enemyRiposteRank = 3;
}
var enemyRelentlessRank = parseInt(document.getElementById("enemy_relentless").value);
if(isNaN(enemyRelentlessRank)) {
    enemyRelentlessRank = 0;
} else if(enemyRelentlessRank > 3) {
    enemyRelentlessRank = 3;
}
var enemyBladeStormRank = parseInt(document.getElementById("enemy_blade_storm").value);
if(isNaN(enemyBladeStormRank)) {
    enemyBladeStormRank = 0;
} else if(enemyBladeStormRank > 3) {
    enemyBladeStormRank = 3;
}
var enemySecondChanceRank = parseInt(document.getElementById("enemy_second_chance").value);
if(isNaN(enemySecondChanceRank)) {
    enemySecondChanceRank = 0;
} else if(enemySecondChanceRank > 3) {
    enemySecondChanceRank = 3;
}
var enemyVengeanceStrikeRank = parseInt(document.getElementById("enemy_vengeance_strike").value);
if(isNaN(enemyVengeanceStrikeRank)) {
    enemyVengeanceStrikeRank = 0;
} else if(enemyVengeanceStrikeRank > 3) {
    enemyVengeanceStrikeRank = 3;
}
var enemyRepelBoardersRank = parseInt(document.getElementById("enemy_repel_boarders").value);
if(isNaN(enemyRepelBoardersRank)) {
    enemyRepelBoardersRank = 0;
} else if(enemyRepelBoardersRank > 3) {
    enemyRepelBoardersRank = 3;
}
var enemyCheapShotRank = parseInt(document.getElementById("enemy_cheap_shot").value);
if(isNaN(enemyCheapShotRank)) {
    enemyCheapShotRank = 0;
} else if(enemyCheapShotRank > 3) {
    enemyCheapShotRank = 3;
}
var enemyFlankingRank = parseInt(document.getElementById("enemy_flanking").value);
if(isNaN(enemyFlankingRank)) {
    enemyFlankingRank = 0;
} else if(enemyFlankingRank > 3) {
    enemyFlankingRank = 3;
}
var enemyHoldTheLineRank = parseInt(document.getElementById("enemy_hold_the_line").value);
if(isNaN(enemyHoldTheLineRank)) {
    enemyHoldTheLineRank = 0;
} else if(enemyHoldTheLineRank > 3) {
    enemyHoldTheLineRank = 3;
}
var enemyElusiveRank = parseInt(document.getElementById("enemyelusive").value);
if(isNaN(enemyElusiveRank)) {
    enemyElusiveRank = 0;
} else if(enemyElusiveRank > 3) {
    enemyElusiveRank = 3;
}
var enemyTurnTheTideRank = parseInt(document.getElementById("enemyturnthetide").value);
if(isNaN(enemyTurnTheTideRank)) {
    enemyTurnTheTideRank = 0;
} else if(enemyTurnTheTideRank > 3) {
    enemyTurnTheTideRank = 3;
}
var enemyImprovedMojoBlastRank = parseInt(document.getElementById("enemyimprovedmojoblast").value);
if(isNaN(enemyImprovedMojoBlastRank)) {
    enemyImprovedMojoBlastRank = 0;
} else if(enemyImprovedMojoBlastRank > 3) {
    enemyImprovedMojoBlastRank = 3;
}
var enemyWitchHunterRank = parseInt(document.getElementById("enemywitchhunter").value);
if(isNaN(enemyWitchHunterRank)) {
    enemyWitchHunterRank = 0;
} else if(enemyWitchHunterRank > 3) {
    enemyWitchHunterRank = 3;
}
...
var activateGoBananas = false;
var goBananasPrompt = function() {
    activateGoBananas = prompt("Attack with Go Bananas?")
    if(activateGoBananas === null) {
        activateGoBananas = "NO"
    } else {
        activateGoBananas = activateGoBananas.toUpperCase();
    }
    checkGoBananasFunction();
};
var checkGoBananasFunction = function() {
    if(activateGoBananas === "YES") {
        activateGoBananas = true;
        powerAvailability = false;
    } else if(activateGoBananas === "NO") {
        activateGoBananas = false;
    } else {
        confirm("Your choice was not recognized. Try again?");
        goBananasPrompt();
    }
...
// OPTION ANALYSIS
//document.getElementById('simulator_wrapper').innerHTML = "ANALYZING OPTIONS..."
...
// NOTES
console.log("NOTES:")
console.log('"Success" is defined by a larger percentage of enemy health lost than unit health lost.')
console.log("Disengaging is only an option if the enemy has the Cheap Shot epic ability. A unit's epic abilities can trigger in response and the resulting combat is analyzed.")
console.log("It is assumed that a unit is approaching when moving into Flanking. As such, Repel Boarders and Hold The Line are taken into account in the calculation.")
...
var optionNames = ["Attack", "Approach and attack", "Disengage from combat", "Flank and attack"] //Initialize parallel array 1
